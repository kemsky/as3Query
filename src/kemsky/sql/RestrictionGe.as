package kemsky.sql
{
    public class RestrictionGe implements IRestriction
    {
        ...
        public function RestrictionGe(attr_name:String, value:*)
        {
        ...
        {
            return "RestrictionGe{attr_name=" + String(attr_name) + ",param_name=" + String(param_name) + ",params=" + String(params) + "}";
        }
    }
}
